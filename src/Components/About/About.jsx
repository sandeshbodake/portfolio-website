      ...
      <div className="wrapper">
        <article>
          ...
          <div className="desc full">
            ...
            <p>
              I am 22 year old, Software Engineer at <a href="https://scalereal.com/" target="_blank">ScaleReal Technologies</a>
            </p>
            <p>
          ...
          <div className="desc">
            ...
            <p>
              For the backend I usually work with Ruby on Rails which is a Ruby framework, ReactJS for frontend. 
          ...
          <div className="desc">
            ...
            <p>
              I Like writing technical blogs, you can view my blogs through medium {mediumLink}. creating cool websites,
